    ...
    public class ManageGame : IWindowEffects
    {
        public void ActivateButton(Game1 game, Window source, ObjectSprite origin, int buttonIndex)
        {
            if (buttonIndex == 0)
            {
                ...
                game.gameXeniaSettingsWindow = new Window(game, new Rectangle(260, 135, 1400, 850), "Xenia Settings for " + game.gameData[game.index].gameTitle, "Note: These settings only apply to this game", new XeniaGameSettings(), new XeniaGameInput(), new GenericStart(), Game1.State.GameMenu, true);
                // First set
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(285, 325, 90, 90), "For XBLA games, the license to use:\n  - (0) : No License, Trial Mode\n  - (1) : First License, Full Game Mode\n  - (-1) : All Licenses, (Can be buggy)", Ozzz.DescriptionBox.SpawnPositions.BelowRight, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(865, 325, 90, 90), "For XBLA games, the license to use:\n  - (0) : No License, Trial Mode\n  - (1) : First License, Full Game Mode\n  - (-1) : All Licenses, (Can be buggy)", Ozzz.DescriptionBox.SpawnPositions.BelowLeft, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(285, 425, 90, 90), "When enabled, Continuum will not copy Xenia\nexecutables to the game save directory.\nThis means you must provide a Xenia/Xenia Canary\nexecutable yourself.", Ozzz.DescriptionBox.SpawnPositions.BelowRight, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(865, 425, 90, 90), "When enabled, Continuum will not copy Xenia\nexecutables to the game save directory.\nThis means you must provide a Xenia/Xenia Canary\nexecutable yourself.", Ozzz.DescriptionBox.SpawnPositions.BelowLeft, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(285, 525, 90, 90), "Enables Xenia's cache mount for this game. Usually\nmore resource intensive. Some games require this,\nsuch as the Forza titles.", Ozzz.DescriptionBox.SpawnPositions.BelowRight, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(865, 525, 90, 90), "Enables Xenia's cache mount for this game. Usually\nmore resource intensive. Some games require this,\nsuch as the Forza titles.", Ozzz.DescriptionBox.SpawnPositions.BelowLeft, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(285, 625, 90, 90), "When on, Xenia will read back CPU shader memory\nexports during emulation. Highly resource intensive, but can\nimprove emulation quality. Some games require this to be\nenabled, but it can also adversely affect emulation in others.", Ozzz.DescriptionBox.SpawnPositions.AboveRight, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(865, 625, 90, 90), "When on, Xenia will read back CPU shader memory\nexports during emulation. Highly resource intensive, but can\nimprove emulation quality. Some games require this to be\nenabled, but it can also adversely affect emulation in others.", Ozzz.DescriptionBox.SpawnPositions.AboveLeft, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(285, 725, 90, 90), "Change the language for this game to run in.\nNote: Not all games support all languages.", Ozzz.DescriptionBox.SpawnPositions.AboveRight, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(865, 725, 90, 90), "Change the language for this game to run in.\nNote: Not all games support all languages.", Ozzz.DescriptionBox.SpawnPositions.AboveLeft, 0.4f);
                ...
                game.gameXeniaSettingsWindow.AddText(">");
                // Second set
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(975, 325, 90, 90), "Adjusts Xenia's internal resolution scale on the\nX-axis. Does not change window size or monitor\nresolution. Reduces performance and may break\nsome games.", Ozzz.DescriptionBox.SpawnPositions.BelowRight, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(1545, 325, 90, 90), "Adjusts Xenia's internal resolution scale on the\nX-axis. Does not change window size or monitor\nresolution. Reduces performance and may break\nsome games.", Ozzz.DescriptionBox.SpawnPositions.BelowLeft, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(975, 425, 90, 90), "Adjusts Xenia's internal resolution scale on the\nY-axis. Does not change window size or monitor\nresolution. Reduces performance and may break\nsome games.", Ozzz.DescriptionBox.SpawnPositions.BelowRight, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(1545, 425, 90, 90), "Adjusts Xenia's internal resolution scale on the\nY-axis. Does not change window size or monitor\nresolution. Reduces performance and may break\nsome games.", Ozzz.DescriptionBox.SpawnPositions.BelowLeft, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(975, 525, 90, 90), "When enabled, V-Sync limits framerate to the monitor's\nrefresh rate. Enable to reduce screen tearing. Will not\nimprove framerate. Does not work with some games,\nsuch as the Halo titles.", Ozzz.DescriptionBox.SpawnPositions.BelowRight, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(1545, 525, 90, 90), "When enabled, V-Sync limits framerate to the monitor's\nrefresh rate. Enable to reduce screen tearing. Will not\nimprove framerate. Does not work with some games,\nsuch as the Halo titles.", Ozzz.DescriptionBox.SpawnPositions.BelowLeft, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(975, 625, 90, 90), "The graphics renderer for Xenia to use:\n  - Any: Let Xenia choose the renderer (Likely D3D12)\n  - D3D12: Default, works best in most games\n  - Vulkan: Experimental, can sometimes work best", Ozzz.DescriptionBox.SpawnPositions.AboveRight, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(1545, 625, 90, 90), "The graphics renderer for Xenia to use:\n  - Any: Let Xenia choose the renderer (Likely D3D12)\n  - D3D12: Default, works best in most games\n  - Vulkan: Experimental, can sometimes work best", Ozzz.DescriptionBox.SpawnPositions.AboveLeft, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(975, 725, 660, 90), "Enter an additional set of arguments to pass\nthrough to Xenia via the command line.", Ozzz.DescriptionBox.SpawnPositions.AboveLeft, 0.4f);
                game.gameXeniaSettingsWindow.AddButton(new Rectangle(605, 845, 700, 100));
                game.gameXeniaSettingsWindow.AddText("<");
                game.gameXeniaSettingsWindow.AddText(">");
                game.gameXeniaSettingsWindow.AddText("<");
                game.gameXeniaSettingsWindow.AddText(">");
                ...
                game.gameXeniaSettingsWindow.AddText("<");
                game.gameXeniaSettingsWindow.AddText(">");
                game.gameXeniaSettingsWindow.AddText("Additional Parameters");
